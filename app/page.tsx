...
const submit = async (e?: any) => {
  ...
  try {
    ...
    setSessionStarted(true); // 🔁 Move to report UI now
    ...
    setReports((prev) =>
      prev.map((r) =>
        r.id === tempId ? { ...r, report: analyzeRes.data, loading: false } : r
      )
    );
...
{loading && !sessionStarted && (
  <div className="mt-4 text-gray-500 italic animate-pulse">
...
<header className="space-y-2 border-b pb-6">
  ...
  <p className="text-gray-500 text-sm">
    Generated by automated RAG pipeline reasoning and source verification.
  </p>
</header>
  ...
  {loading && !report && (
    <div className="space-y-4">
      ...
      <div className="text-gray-500 italic animate-pulse">
        Analyzing the claim using trusted sources...
      </div>
    </div>
  )}
